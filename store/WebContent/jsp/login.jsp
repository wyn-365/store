...
<form class="form-horizontal" action="${pageContext.request.contextPath}/userServlet?method=userLogin" method="post">
 ...
 <div class="form-group">
   ...
   <label for="checkcode" class="col-sm-2 control-label">验证码</label>   
    <div class="col-sm-3">
     <input type="text" name="verifycode" class="form-control" id="verifycode" placeholder="请输入验证码" style="width: 105px;"/>  </div>
    <div class="col-sm-3">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
    <input type="submit"  width="100" value="登录"  border="0" id="login_btn"
