...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	<%--分页显示的开始 --%>
    	<div style="text-align:center">
    		<p style="color: blue">一共有${page.totalPageNum}页/第${page.currentPageNum}页</p>
    		
    		<a href="${pageContext.request.contextPath}/${page.url}&num=1" style="color: blue;font-size: 18px">首页</a>
    		...
    		<a href="${pageContext.request.contextPath}/${page.url}&num=${page.totalPageNum}" style="color: blue;font-size: 18px">末页</a>
