					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								bordercolor="black" border="1" id="DataGrid1" 
										...
										<tr onmouseover="this.style.backgroundColor = 'pink'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="5%">
													...
													<c:if test="${o.state==1}">
													<a href="#" style="color:red">未付款</a>
													</c:if>
													
													<c:if test="${o.state==2}">
														<a href="/store/adminOrderServlet?method=updateOrderByOid&oid=${o.oid}" style="color:blue">请发货</a>
													</c:if>
													
													<c:if test="${o.state==3}">
													<a href="#" style="color:green">已发货</a>
													</c:if>
													
													<c:if test="${o.state==4}">
													<a href="#" style="color:green">订单完成</a>
													</c:if>
