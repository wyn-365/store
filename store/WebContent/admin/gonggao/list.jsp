				...
				<TBODY>
					...
					<tr>
						<td class="ta_01" align="right">
							<button type="button" id="add" name="add" value="添加商品" class="button_add" onclick="addGong()">&#28155;&#21152;</button>
						</td>
					</tr>
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<c:forEach items="${gonggao}" var="u" varStatus="p">
										<tr onmouseover="this.style.backgroundColor = 'pink'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/index02Servlet?method=deleteGongGao&id=${u.id}">
